    ...
    <div class="w-full mt-8">
        ...
        <form class="rounded pb-8" action="admin/admin-login.php" method="post">
            ...
            <div class="mb-6">
                ...
                <input name="password" class="bg-white rounded-full shadow appearance-none border-black border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight" id="password" type="password" placeholder="******************">
            </div>
