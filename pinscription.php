...
<div class="mx-auto md:w-max w-full h-full mt-8">
    <div class="w-full mt-8">
        <h1 class="text-center text-2xl text-[#3B5998] font-bold mb-8">Inscription</h1>
        <form class="rounded pb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-4">
                ...
                <div class="mb-4">
                    ...
                    <input class="bg-white shadow appearance-none border border-black rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline rounded-full" id="confirm-email" type="email" placeholder="Confirmez votre e-mail">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-4">
                <div class="mb-4">
                    ...
                    <input class="bg-white shadow appearance-none border border-black rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline rounded-full" id="password" type="password" placeholder="Mot de passe">
                </div>
                <div class="mb-4">
